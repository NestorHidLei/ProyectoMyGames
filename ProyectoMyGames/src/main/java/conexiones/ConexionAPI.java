...
public class ConexionAPI {
     ...
     * @return Información del juego (id, nombre, portada, rating).
     */
    public String[] buscarJuegoPorId(String id) {
        ...
        try (Response respuesta = cliente.newCall(solicitud).execute()) {
            if (respuesta.isSuccessful()) {
                ...
                String portada = juego.has("background_image") ? juego.get("background_image").getAsString() : "No disponible";
     ...
     *
     * @param etiqueta Etiqueta del juego (por ejemplo, "multiplayer", "singleplayer").
     * @return Lista de información de juegos (id, nombre, portada, rating).
     */
    ...
    /**
     * Realiza una solicitud HTTP para obtener juegos y devuelve una lista con sus detalles.
     *
